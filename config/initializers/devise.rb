...
Devise.setup do |config|
  ...
  # config.secret_key = 'd15a01adb8a19c2c30c81ef4ead1d80644c74054b70e2bda45671b09a34b3599fe3a08f9a9f5702b03a7bf098dc54a7ad426c05114d97f1e08a790ddf70fefa5'
  ...
  # config.pepper = '2c6f9cdcd653979276203b0b8b11bfb881f6d88ea7b8b35db72515385f9208b1227dc4922152e2761e7ae48dd5a449f27e17aae04a1ec27ada72165df4f38275'
  ...
  # ==> Configuration for :saml_authenticatable
    ...
    config.saml_configure do |settings|
      ...
      settings.assertion_consumer_service_url     = "#{ENV['URL_ROOT']}users/saml/auth"
      settings.assertion_consumer_service_binding = 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST'
      settings.name_identifier_format             = 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress'
      settings.sp_entity_id                       = "#{ENV['URL_ROOT']}users/saml/metadata"
      settings.authn_context                      = 'urn:oasis:names:tc:SAML:2.0:ac:classes:PasswordProtectedTransport'
      settings.idp_slo_target_url                 = "#{ENV['URL_IDP']}/saml2"
      settings.idp_slo_service_binding            = "urn:oasis:names:tc:SAML:2.0:bindings:HTTP-POST"
      settings.idp_sso_target_url                 = "#{ENV['URL_IDP']}/saml2"
      settings.idp_cert_fingerprint               = (ENV['FINGERPRINT_IDP']).to_s
