...
Type.create([{name: "Petit-déjeuner", enabled: true}, {name: "Soupe", enabled: true}, {name: "Petite faim", enabled: true}, {name: "Sandwich", enabled: true},{name: "Salade", enabled: true}, {name: "Pâtes", enabled: true}, {name: "Boisson", enabled: true}])
...
Dish.create(name: "Croque-monsieur avec crudités",price: 2.50, type: Type.where(name: "Petite faim").first, enabled: true)
...
Dish.create(name: "Baguette garnie poulet andalouse",price: 3.00, type: Type.where(name: "Sandwich").first, enabled: true)
...
Dish.create(name: "Baguette garnie salade de viande",price: 3.00, type: Type.where(name: "Sandwich").first, enabled: true)
...
Dish.create(name: "Salade composée roulade d'asperge",price: 4.00, type: Type.where(name: "Salade").first, enabled: true)
